        ...
        <div>
            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 mb-6">
                        <div className="form-control w-full flex-col">
                            ...
                            <select {...register("category", { require: true })}
                                className="select select-bordered w-full" defaultValue={"default"}>Select a Category
                    ...
                    <button className="btn bg-gradient-to-r from-[#835D23] to-[#B58130] text-white">Add Item <FaUtensils className="ml-4" /></button>
                </form>
            </div>
        </div>
    );
